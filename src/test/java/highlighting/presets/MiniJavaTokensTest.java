...
import static org.junit.jupiter.api.Assertions.*;
    ...
    class MiniJavaTokensTest {
        ...
        // (Achtung: Wenn du die Reihenfolge in MiniJavaTokens änderst, musst du die Indizes hier anpassen!)
        ...
        void testStringsWithCommentFakes() {
            ...
            assertEquals(34, matches.get(0).end()); // Index 11 bis 34 umfasst genau "\"/* fake */ // comment\""
        }
        ...
        void testCommentsAreDifferentiated() {
            // Prüft, ob ein Javadoc-Kommentar richtig erkannt wird und NICHT vom normalen Blockkommentar geschluckt wird
